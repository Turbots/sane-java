...
/* -----------------------------------------------------------------------------
 * be.hubau.sane.parser.Rule_map_pair.java
 * -----------------------------------------------------------------------------
 *
...
class Rule_map_pair(spelling: String, rules: ArrayList<Rule>) : Rule(spelling, rules) {
    ...
    companion object {
        ...
        fun parse(context: ParserContext): Rule_map_pair? {
            ...
            var rule: Rule? = null
            if (parsed) {
                rule = Rule_map_pair(context.text.substring(a0.start, a0.end), a0.rules)
            } else {
                context.index = s0
            }
