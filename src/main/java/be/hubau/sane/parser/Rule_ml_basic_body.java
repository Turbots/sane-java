...
final public class Rule_ml_basic_body extends Rule {
    public Rule_ml_basic_body(String spelling, ArrayList<Rule> rules) {
        super(spelling, rules);
    }

    public static Rule_ml_basic_body parse(ParserContext context) {
                    ...
                    parsed = false;
                    {
                        ...
                        if (parsed) {
                            ...
                            for (int i2 = 0; i2 < 1 && f2; i2++) {
                                Rule rule = Rule_ml_basic_char.parse(context);
                                if ((f2 = rule != null)) {
        ...
        Rule rule = null;
        if (parsed) {
            rule = new Rule_ml_basic_body(context.text.substring(a0.start, a0.end), a0.rules);
        } else {
            context.index = s0;
        }
        ...
        return (Rule_ml_basic_body) rule;
    }
