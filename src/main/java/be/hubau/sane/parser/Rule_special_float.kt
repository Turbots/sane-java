...
/* -----------------------------------------------------------------------------
 * be.hubau.sane.parser.Rule_special_float.java
 * -----------------------------------------------------------------------------
 *
...
class Rule_special_float(spelling: String, rules: ArrayList<Rule>) : Rule(spelling, rules) {
    ...
    companion object {
        ...
        fun parse(context: ParserContext): Rule_special_float? {
            context.push("special-float")
                    ...
                    while (i1 < 1 && f1) {
                        ...
                        run {
                            ...
                            if (parsed) {
                                ...
                                var i2 = 0
                                while (i2 < 1 && f2) {
                                    val rule = Rule_minus.parse(context)
                                    f2 = rule != null
                                    if (f2) {
                        ...
                        run {
                            ...
                            if (parsed) {
                                ...
                                var i2 = 0
                                while (i2 < 1 && f2) {
                                    val rule = Rule_plus.parse(context)
                                    f2 = rule != null
                                    if (f2) {
                                        a2.add(rule, context.index)
                                        c2++
                    ...
                    while (i1 < 1 && f1) {
                        ...
                        run {
                            ...
                            if (parsed) {
                                ...
                                var i2 = 0
                                while (i2 < 1 && f2) {
                                    val rule = Rule_inf.parse(context)
                                    f2 = rule != null
                                    if (f2) {
                                        a2.add(rule, context.index)
                                        c2++
                        ...
                        run {
                            ...
                            if (parsed) {
                                ...
                                var i2 = 0
                                while (i2 < 1 && f2) {
                                    val rule = Rule_nan.parse(context)
                                    f2 = rule != null
                                    if (f2) {
                                        a2.add(rule, context.index)
                                        c2++
            ...
            var rule: Rule? = null
            if (parsed) {
                rule = Rule_special_float(context.text.substring(a0.start, a0.end), a0.rules)
            } else {
                context.index = s0
            }

            context.pop("special-float", parsed)

            return rule as Rule_special_float?
        }
    }
}
